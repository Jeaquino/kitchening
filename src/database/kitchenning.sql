CREATE DATABASE  IF NOT EXISTS `kitchenning` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `kitchenning`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: kitchenning
-- ------------------------------------------------------
...
CREATE TABLE `images` (
  ...
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `images_ibfk_1_idx` (`productId`),
...
CREATE TABLE `items` (
  ...
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `items_ibfk_1_idx` (`orderId`),
  KEY `items_ibfk_2_idx` (`productId`),
  CONSTRAINT `items_ibfk_1` FOREIGN KEY (`orderId`) REFERENCES `orders` (`id`),
  CONSTRAINT `items_ibfk_2` FOREIGN KEY (`productId`) REFERENCES `products` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `orders_ibfk_2_idx` (`statusId`),
...
CREATE TABLE `products` (
  ...
  `image` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `products_ibfk_1_idx` (`sectionId`),
  KEY `products_ibfk_2_idx` (`brandId`),
...
-- Dump completed on 2024-02-06 15:50:39
